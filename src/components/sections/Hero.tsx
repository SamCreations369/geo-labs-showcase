...
export function Hero() {
  ...
  return <section ref={ref} className="relative sky-gradient overflow-hidden">
      {/* Cloud decorations */}
      ...
      <div className="section-container relative z-10 pt-32 pb-8">
        ...
        duration: 0.6
          ...
          <p className="text-lg sm:text-xl max-w-2xl mx-auto mb-10 text-secondary-foreground">
        ...
        rotateX: imageRotateX
          ...
          damping: 20
            ...
            <img src={dashboardImage} alt="GEO Labs Dashboard showing search visibility metrics" className="w-full rounded-2xl shadow-2xl" style={{
